...
import render25dStage1d2 from '@app/stages/Stage1e/render25dBefore';
import render25d from '@app/stages/Stage1e/render25d';
import defaultSettings from '@app/stages/Stage1e/settings';
...
const Stage: Component = () => {
  ...
  return (
    <div class="flex flex-col gap-4">
      ...
      <p class="py-2 text">
        Решение проблемы заключается в том, чтобы отсортировать стены по расстоянию от камеры перед их отрисовкой. Сначала рисуем дальние стены и только затем ближние. Кстати, такой алгоритм отрисовки называется <a href="https://ru.wikipedia.org/wiki/%D0%90%D0%BB%D0%B3%D0%BE%D1%80%D0%B8%D1%82%D0%BC_%D1%85%D1%83%D0%B4%D0%BE%D0%B6%D0%BD%D0%B8%D0%BA%D0%B0" class="link underline" target="_blank">Алгоритмом художника</a>:
      </p>
