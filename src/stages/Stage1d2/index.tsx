...
const Stage: Component = () => {
  ...
  return (
    <section class="flex flex-col gap-4">
      <p class="py-text">
        В прошлом примере стены были расположены так, что всегда были повернуты лицом к камере. Если расположить стены по другому, например, как на демо ниже и слева, то можно заметить, что ранее реализованная линейная интерпорляция не работает.
      </p>
      <p class="py-text">
        Здесь необходимо учитывать угол между стеной и направлением взгляда, чтобы создать правильное перспективное искажение. Поэтому мы введем специальный коэффициент, <Label>scale factor</Label>, учитывающий ориентацию стены относительно луча зрения.
      </p>
