...
const Stage: Component = () => {
  ...
  return (
    <section class="flex flex-col gap-4">
      <p class="py-2 text">
        Самое тяжелое в проектировании это определить базовый набор идей и абстракций. И честно говоря, в свое время мне было тяжело понять какой шаг нужно было сделать первым, пока не познакомился с заметками <a class="link underline" href="https://github.com/amroibrahim/DIYDoom/tree/master/DIYDOOM/Notes011/notes" target="_blank">DIYDoom</a>, а в частности с ем, как необходимо сделать <a class="link underline" href="https://github.com/amroibrahim/DIYDoom/tree/master/DIYDOOM/Notes011/notes" target="_blank">горизонтальную проекцию</a>.
      </p>
      <p class="py-2 text">
        На этом шаге необходимо сделать проекция вершины на камеру в виде вертикальной линии.
      </p>
      ...
      <p class="py-2 text">
        Получившийся мир для нас это множество спроекцированных точек в виде верткальных линий:
      </p>
