...
const Stage: Component = () => {
  ...
  return (
    <section class="flex flex-col gap-4">
      ...
      <p class="py-2 text">
        Если построить несколько линий вряд и использовать формулу из прошлой заметки, то можно обнаружить, что изображение будто   проходит через линзу, получается немного выпуклым — это называется эффектом рыбьего глаза:
      </p>
      ...
      <p class="py-2 text">
        Дело в том, что вычисление высоты не зависело от угла относительно камеры. Решается эта проблема благо очень просто:
      </p>
      ...
      <h2 class="text-2xl">Как это исправить</h2>
      <p class="py-2 text">
