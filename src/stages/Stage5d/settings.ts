...
const columnSector1: Sector = { id: 6, floorHeight: 2_000,  floorTexture: "floor", ceilHeight: 8_000, ceilTexture: "ceil", wallColor: "red", wallTexture: 'wall', segs: []};
const columnSector2: Sector = { id: 7, floorHeight: 0, floorTexture: "floor", ceilHeight: 8_000, ceilTexture: "ceil", wallColor: "#900000", wallTexture: 'wall', segs: []};
const columnSector3: Sector = { id: 8, floorHeight: 8_000, floorTexture: "floor", ceilHeight: 8_000, ceilTexture: "ceil", wallColor: "#900000", wallTexture: 'wall', segs: []};
const columnSector4: Sector = { id: 9, floorHeight: 10_000, floorTexture: "floor", ceilHeight: 10_000, ceilTexture: "ceil", wallColor: "red", wallTexture: 'wall', segs: []};
const columnSector5: Sector = { id: 10, floorHeight: 9_000, floorTexture: "floor", ceilHeight: 9_000, ceilTexture: "ceil", wallColor: "#900000", wallTexture: 'wall', segs: []};
const columnSector6: Sector = { id: 10, floorHeight: 7_000, floorTexture: "floor", ceilHeight: 7_000, ceilTexture: "ceil", wallColor: "red", wallTexture: 'wall',  segs: []};
