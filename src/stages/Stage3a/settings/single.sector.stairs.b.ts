...
const sector4Lines = createCircleLines(centerX, centerY, 40, 6).map(seg => ({
  ...seg,
  frontSector: sector4,
  backSector: sector3,
  isTwoSide: true
...
const sector3Lines = createCircleLines(centerX, centerY, 80, 8).map(seg => ({
  ...seg,
  frontSector: sector3,
  backSector: sector2,
  isTwoSide: true
...
const sector2Lines = createCircleLines(centerX, centerY, 120, 10).map(seg => ({
  ...seg,
  frontSector: sector2,
  backSector: sector1,
  isTwoSide: true
...
const sector1Lines = createCircleLines(centerX, centerY, 200, 12).map(seg => ({
  ...seg,
  frontSector: sector1,
