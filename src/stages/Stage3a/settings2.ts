...
const columnSegs: Seg[] = [
  { start: { x: 150, y: 150 }, end: { x: 250, y: 150 }, isTwoSide: false, frontSector: columnSector, backSector: roomSector },
  { start: { x: 250, y: 150 }, end: { x: 250, y: 250 }, isTwoSide: false, frontSector: columnSector, backSector: roomSector },
  { start: { x: 250, y: 250 }, end: { x: 150, y: 250 }, isTwoSide: false, frontSector: columnSector, backSector: roomSector },
  { start: { x: 150, y: 250 }, end: { x: 150, y: 150 }, isTwoSide: false, frontSector: columnSector, backSector: roomSector },
];
