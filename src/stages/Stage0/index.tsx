...
const Stage: Component = () => {
  ...
  return (
    <section class="flex flex-col gap-4">
      <h2 class="text-2xl">Двумерная карта</h2>
      <p class="py-2">
      ...
      <Map2d width={600} height={400} settings={settings} render={render2d} />
      <p class="py-2">
        TODO 
      </p>
      ...
      <p class="my-2">
        <RepoLink filePath="stages/Stage0/render25d.ts">Исходники реализации шага на Github</RepoLink>
      </p>
    </section>
  );
};
